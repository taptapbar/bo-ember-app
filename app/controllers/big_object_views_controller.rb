class BigObjectViewsController < ApplicationController
  ...
  def filter_list
    render json: {
      'filter_list' => [
        { 'Dimension-A' => ['sub-a', 'sub-b', 'sub-c', 'sub-d', 'sub-e','sub-a', 'sub-b', 'sub-c', 'sub-d', 'sub-e']},
        { 'Dimension-B' => ['sub-aaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j', 'sub-k', 'sub-l', 'sub-m', 'sub-n', 'sub-o','sub-a', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j', 'sub-k', 'sub-l', 'sub-m', 'sub-n', 'sub-o']},
        { 'Dimension-C' => ['subaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-a', 'sub-b', 'sub-c', 'sub-d']},
        { 'Dimension-D' => ['sub-', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j', 'sub-k', 'sub-l', 'sub-m', 'sub-n', 'sub-o','sub-a', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j', 'sub-k', 'sub-l', 'sub-m', 'sub-n', 'sub-o']},
        { 'Dimension-E' => ['sub-aaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j', 'sub-k', 'sub-l', 'sub-m', 'sub-n', 'sub-o','sub-a', 'sub-b', 'sub-c', 'sub-d', 'sub-e', 'sub-f', 'sub-g', 'sub-h', 'sub-i', 'sub-j']}
      ]
    }
  end
